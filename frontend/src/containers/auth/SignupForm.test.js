...
describe('SignupForm Test', ()=>{
    ...
    it('should render SignupForm', ()=>{
        ...
        let wrapper=component.find('.SignupForm')
    ...
    it('should call clickCheckEmail', (done)=>{
        ...
        const component=mount(signupForm)
        let wrapper = component.find('button#checkEmail')
        expect(wrapper.length).toBe(1)
    ...
    it('should call clickCheckPassword', ()=>{
        const component=mount(signupForm)
        let wrapper = component.find('button#checkPassword')
        expect(wrapper.length).toBe(1)
        wrapper.simulate('click')

        let wrapper1 = component.find('input').find({name:"password"});
    ...
    it('should call clickCheckNickname', (done)=>{
        const component=mount(signupForm)
        let wrapper = component.find('button#checkNickname')
        expect(wrapper.length).toBe(1)
        wrapper.simulate('click')
    ...
    it('should call clickSubmit', ()=>{
        ...
        const component=mount(signupForm)
        let wrapper = component.find('button#submit')
        expect(wrapper.length).toBe(1)
        wrapper.simulate('click')
